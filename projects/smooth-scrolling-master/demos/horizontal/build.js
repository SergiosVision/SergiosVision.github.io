...
var Smooth = function () {
    function Smooth() {
        ...
        this.vars = {
            ...
            timer: null,
            ticking: false,
            fixOffset: this.options.fixOffset || 50
        };
        ...
        this.dom = {
            ...
            parentSection: document.querySelector('.thisWrap'),
    ...
    _createClass(Smooth, [{
        ...
        value: function calc(e) {
            ...
            var delta = this.vars.direction == 'horizontal' ? e.deltaY : e.deltaY;
        ...
        value: function calcScroll(e) {
            ...
            var client = this.vars.direction == 'vertical' ? e.clientY : e.clientY;
            var bounds = this.vars.direction == 'vertical' ? this.vars.height : this.vars.width;
